module Page.Results.View exposing (..)
    ...
    Element.row
        ...
        [ Element.Input.text
            ...
            , label =
                Element.el
                    NoStyle
                    [ Element.Attributes.verticalCenter, Element.Attributes.center ]
                    (Element.text "Enter your roomname")
                    |> Element.Input.labelAbove
            , options = []
            }
        , Element.button RoomNameJoin [ Element.Attributes.paddingXY 20 2 ] (Element.text "Join!")
        ]
        |> Element.el NoStyle
...
viewNewIndex model =
    Element.wrappedColumn
        ...
        , case model.errors of
            ...
            errors ->
                Element.row NoStyle [ Element.Attributes.center, Element.Attributes.verticalCenter ] (List.map Element.text errors)
        , Element.el NoStyle [] (Element.text "")
        ]
...
viewRoomInfo roomInfo =
    Element.wrappedColumn
        ...
        , Element.button NoStyle [ onClick (JoinedRoom roomInfo.roomName) ] (Element.text "Join room")
        , Element.el NoStyle [] (Element.text "")
        , Element.el NoStyle [] (Element.text "")
        ]
